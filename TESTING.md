...
Vitest + React Testing Library + MSW. Business/feature tests are added incrementally; this file tracks what is done and what is deferred.
...
| `src/lib/**/__tests__/` or `*.test.ts` | Unit tests next to or under modules |
